```jsx
// Covers: src/App.jsx
// Implements: Unit Tests — formatDayShort(), API response parsing, day-card rendering, error handling
...
describe('Error handling for API failure', () => {
  it('updates error state when API call fails', async () => {
    vi.spyOn(global, 'fetch').mockImplementationOnce(() => Promise.reject('API is down'));
    
    render(<App />);
    
    // Simulate API call and check for error state
